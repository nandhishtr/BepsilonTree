...
//    m_cktRootNodeKey = m_ptrCache->createObjectOfType<LeafNode<KeyType, ValueType, CacheType, CacheKeyType>>(5);
//
...
//
//    INodePtr ptrRootNode = m_ptrCache->getObjectOfType<INode<KeyType, ValueType, CacheType, CacheKeyType>>(*m_cktRootNodeKey);
//    if (ptrRootNode == NULL)
...
//        if (ptrSibling)
//        {
//            m_cktRootNodeKey = m_ptrCache->createObjectOfType<InternalNode<KeyType, ValueType, CacheType, CacheKeyType>>(5, nPivot, *m_cktRootNodeKey, *ptrSibling);
//        }
//    }
//
//    return nRes;

...
protected:
    BTree<int, string, DRAMLRUCache<DRAMVolatileStorage, uintptr_t, IDRAMCacheObject, DRAMCacheObject>>* m_objBPlusTree;
    ...
    void SetUp() override {
        m_objBPlusTree = new BTree<int, string, DRAMLRUCache<DRAMVolatileStorage, uintptr_t, IDRAMCacheObject, DRAMCacheObject>>();

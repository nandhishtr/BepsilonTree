...
class BPlusTree_DRAMLRU_Suite_2 : public ::testing::Test
{
protected:
...
TEST_F(BPlusTree_DRAMLRU_Suite_2, Insert_1_Element) {
...
TEST_F(BPlusTree_DRAMLRU_Suite_2, Insert_100_Elements_v1) {
...
TEST_F(BPlusTree_DRAMLRU_Suite_2, Insert_100_Elements_v2) {
...
TEST_F(BPlusTree_DRAMLRU_Suite_2, Insert_100_Elements_v3) {
    for (size_t nCntr = 0; nCntr < 1000; nCntr++)
    {
...
TEST_F(BPlusTree_DRAMLRU_Suite_2, Insert_100_Elements_v4) {
